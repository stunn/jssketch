define(['jquery', 'codemirror/lib/codemirror', 'application', 'jquery-ui', 'bootstrap', 'less', 'handlebars', 'codemirror/mode/css/css',
        'codemirror/mode/javascript/javascript', 'codemirror/mode/xml/xml', 'sexify', 'panes'], function (jQuery, CodeMirror, Application) {
