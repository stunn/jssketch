...
var dm = require('../shared/lib/dependency_manager');
...
function JsSketch(settings) {
  ...
  this.Revision = require('../shared/models/revision').init(this.doctypes);
  this.Sketch = require('../shared/models/sketch').init(this.Revision);
  this.Asset = require('../shared/models/asset');
}
