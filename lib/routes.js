...
module.exports = function (base, jail, config, client) {
   ...
   */
  jail.post(config.getJailUrl('/preview'), createAndValidateRevisionFromPostData, function (req, res, next) {
   ...
   */
  jail.get(config.getJailUrl('/preview/:id/:rev'), loadAndVerifyRevisionFromUrl, function (req, res, next) {
